...
<div class="navbar two" id="navbar">
  ...
  <div class="dropdown">
    <a href="#main" class="dropbtn" onmouseout="this.parentElement.children[1].style.display = 'none';" onmouseover="this.parentElement.children[1].style.display = 'block';">EXPERIENCE</a>
    <div class="dropdown-content" onmouseover="this.parentElement.children[1].style.display = 'block';" onmouseout="this.style.display = 'none';">
      <a href="#main">Education</a>
      <a href="#bcg-parallax2">Technical Skills</a>
      <a href="#project01">Work Experience</a>
      <a href="#project02">Leadership</a>
      <a href="#project03">Other</a>
    </div>
  </div>
  <div class="dropdown">
...
document.querySelector('#navbar-container').insertAdjacentHTML('afterend', navbar);
